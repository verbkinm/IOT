...
uint64_t responseLogData(const char *rawData, uint64_t rawDataSize, char *outData, uint64_t dataSize, const struct Log_Data *pkg, uint64_t (*writeFunc)(char *, uint64_t, void *), void *obj);
