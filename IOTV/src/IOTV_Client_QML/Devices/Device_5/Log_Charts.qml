...
Page {
    ...
    ChartView {
        ...
        ValuesAxis {
            ...
            visible: lineSeriesRele.visible
        }
        ...
        ValuesAxis {
            ...
            visible: lineSeriesDistance.visible
        }
    ...
    function requestLogData(dateStart, dateEnd, intervalMS) {
        ...
        */
        ...
        waitList = []
        waitList[0] = lineSeriesRele.visible
        waitList[3] = lineSeriesDistance.visible
        waitList[5] = lineSeriesTemperature.visible
        waitList[6] = lineSeriesHumidity.visible
        waitList[7] = lineSeriesPressure.visible

        if (lineSeriesRele.visible)
            device.signalQueryLogData(dateStart, dateEnd, 60000, 0, 0)
        if (lineSeriesDistance.visible)
