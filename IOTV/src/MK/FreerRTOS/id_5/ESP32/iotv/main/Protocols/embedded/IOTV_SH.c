...
uint64_t responseReadData(char *outData, uint64_t dataSize, const struct IOTV_Server_embedded *iot, const struct Header *head, uint64_t (*writeFunc)(char *, uint64_t, void *obj), void *obj, uint8_t rw_flags, uint8_t header_flags)
{
...
//	{
//		printf("responseReadData ch 15, pkgsCount = %d\n", (int)pkgsCount);
//	}
...
//		if (rwPkg->channelNumber == 15)
//		{
//			printf("responseReadData ch 15, dataReadSize = %d\n", (int)dataReadSize);
//			if (it == NULL)
//				printf("it = NULL\n");
//		}
