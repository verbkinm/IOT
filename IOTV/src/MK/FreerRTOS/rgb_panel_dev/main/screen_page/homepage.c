...
char *days_str[7] = {"вс", "пн", "вт", "ср", "чт", "пт", "сб"};
...
static void init_block_2(lv_obj_t *parent)
{
	...
	cloud_codver_img = init_img_obj(block_2, CLOUD_COVER_1, block_2, LV_ALIGN_TOP_LEFT, 128, 128, 10, 10);
	precipitations_img = init_img_obj(block_2, PRECIPITATION0, cloud_codver_img, LV_ALIGN_OUT_BOTTOM_MID, 128, 64, 0, 0);

	wind_direction_img = init_img_obj(block_2, WIND_NO, cloud_codver_img, LV_ALIGN_OUT_RIGHT_MID, 128, 128, 20, 20);
	lv_obj_t *wind_img = init_img_obj(block_2, WIND, wind_direction_img, LV_ALIGN_OUT_BOTTOM_LEFT, 32, 32, 20, 20);
	wind_speed_lbl = init_lbl_obj(block_2, "- м/с", wind_img, LV_ALIGN_OUT_RIGHT_MID, 20, -6, lv_color_white(), &ubuntu_mono_26);

	lv_obj_t *temperature_img = init_img_obj(block_2, TEMPERATURE32, precipitations_img, LV_ALIGN_OUT_BOTTOM_MID, 32, 32, 0, 30);
	temperature2_lbl = init_lbl_obj(block_2, "-°C", temperature_img, LV_ALIGN_OUT_RIGHT_MID, 20, -7, lv_color_white(), &ubuntu_mono_26);

	lv_obj_t *humidity_img = init_img_obj(block_2, HUMIDITY32, temperature_img, LV_ALIGN_CENTER, 32, 32, 200, 0);
	humidity_lbl = init_lbl_obj(block_2, "-%", humidity_img, LV_ALIGN_OUT_RIGHT_MID, 20, -7, lv_color_white(), &ubuntu_mono_26);

	lv_obj_t *pressure_img = init_img_obj(block_2, PRESSURE32, temperature_img, LV_ALIGN_OUT_BOTTOM_MID, 32, 32, 0, 10);
	pressure_lbl = init_lbl_obj(block_2, "- мм.рт.cт.", pressure_img, LV_ALIGN_OUT_RIGHT_MID, 20, -6, lv_color_white(), &ubuntu_mono_26);
	...
	precipitation_lbl = init_lbl_obj(block_2, "Осадки: - мм.", apparent_temperature_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
	rain_lbl = init_lbl_obj(block_2, "Дождь: 0 мм.", precipitation_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
	cloud_cover_lbl = init_lbl_obj(block_2, "Облачность: -%", rain_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
	...
	showers_lbl = init_lbl_obj(block_2, "Ливни: - мм.", wind_gusts_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
	snow_lbl = init_lbl_obj(block_2, "Снег: - см.", showers_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
	wind_direction_lbl = init_lbl_obj(block_2, "Ветер: -°", snow_lbl, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 5, lv_color_white(), &ubuntu_mono_14);
