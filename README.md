...
<h2>IOTV_Client</h2>
<ul>
    <li>GUI приложение для связи с сервером. Получение данных о количестве устройств, их тип, получение/отправка данных на устройствства.</li>
...
<p>
    На стороне сервера создаётся 3 .ini файла конфигурации:
<ul>
    <li><b>IOTV_Server.ini</b> - файл настройки сервера. Состоит из следующих полей:</li>
    <ul>
        ...
        <li><b>portHosts</b> - указание udp и tcp порта для подключения хостов <b>TCP_REVERSE, UDP_REVERSE</b></li>
        <li><b>client_log</b> - лог файл подключенных клиентов.</li>
        <li><b>tcp_log</b> - лог файл.</li>
...
<ul>
    ...
    <ul>
        ...
        <li><b>log_file</b> - лог файл данных хоста.</li>
    </ul>
</ul>
<ul>
    <li><b>IOTV_Event_Action.json</b> - файл событий и действий. Не нуждается в ручной правке.</li>
</ul>
</p>
