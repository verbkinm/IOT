...
#include <memory>
#include "../../../IOT/src/IOTSV_server/channels/channelmanager.h"
...
QT_MOC_LITERAL(1, 15, 19), // "signalTimerResponse"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "ChannelManager\0signalTimerResponse\0"
};
...
void ChannelManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalTimerResponse(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ChannelManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChannelManager::signalTimerResponse)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ChannelManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ChannelManager.data,
    qt_meta_data_ChannelManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ChannelManager::signalTimerResponse()
{
