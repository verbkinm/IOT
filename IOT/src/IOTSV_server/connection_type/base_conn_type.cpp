...
Base_conn_type::Base_conn_type(const QString& name, QObject *parent) : QObject(parent), _name(name), _address("none address")
{
...
void Base_conn_type::setName(const QString &name)
{
    _name = name;
}
